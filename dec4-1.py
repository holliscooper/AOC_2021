...
with open('C:/Users/Hollis.000/OneDrive/Code Projects/Advent2021/input4.txt') as file:
    ...
    #print(f" input numbers is {input_numbers}")
...
for puzzle in puzzles:
    ...
    #print(f"single puzzle is {single_puzzle_dict}")
    ...
    for sp_key in all_puzzle_dict:
        ...
        if winner_found != True:
            for key in sp_value:
                ...
                #print(f"key is {key} and value set is {value_set}")
                if value_set.issubset(pulled_numbers):
                    print(f"puzzle {sp_key} with {key}: {value_set} is a winner for current numbers {pulled_numbers}")
                    print(f"entire puzzle is {all_puzzle_dict[sp_key]}")
                    print(f"last number called is {last_number_called}")
                    ...
                    print(f"winning set is {winning_set}")
                    for item in winning_set:
                        if item not in pulled_numbers:
                            winning_total += int(item)

                    #print(f"unmarked set is {unmarked_set}")
                    print(f"winning total is {winning_total}")
